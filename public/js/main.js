      ...
      this.intObs(
        ...
        function () {
          if (!$(this).hasClass("animated")) {
            var $this = $(this);
            if ($this.closest(".owl-carousel.slide-animate").length > 0) if ($this.closest(".owl-item.active").length === 0) return;
            ...
            if ($this.closest(".owl-carousel.slide-animate").length > 0) times.push(id);
          }
        },
        {}
      );
      ...
      $("body")
        ...
        .on("click", ".link-to-tab", function (e) {
          ...
          if (selector == "#shipping" || selector == "#billing") {
            if (!$nav.find('[href="#address"]').hasClass("address")) $nav.find('[href="#address"]').addClass("address");
          } else {
      ...
      $(".grid").each(function () {
        ...
        if (options.sortReorder) {
          var reorderGrid = function () {
            ...
            gridIns.isotope({
              sortBy: windowWidth < 768 && windowWidth > 400 ? "md-order" : "original-order",
            });
          };
    ...
    var thumbsRefresh = function (self) {
      ...
      if (self.$isPgVertical.length > 0) {
        ...
        if (!self.$thumbs.hasClass("owl-carousel") && !self.$thumbs.hasClass("transparent-dots") && !self.$thumbs.hasClass("thumb-vertical")) {
          self.$thumbs.addClass("owl-carousel owl-theme show-nav-hover").owlCarousel($.extend(true, self.isQuickview ? {} : {}, sliderThumb));
        }
      }
    };
